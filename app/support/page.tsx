      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-white dark:bg-blue-800 p-6 rounded-lg shadow-md">                                {/*dark mode*/}
          ...
          <ul className="space-y-2">
            {/* <li className="text-gray-600 mb-4" >National Suicide Prevention Lifeline: 1-800-273-8255</li> */}
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold text-blue-600 mb-4">Online Therapy Platforms</h2>
          <ul className="space-y-2">
